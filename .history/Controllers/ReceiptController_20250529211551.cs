...
namespace OurCheckSplitter.Api.Controllers
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        public async Task<IActionResult> ScanReceipt([FromForm] IFormFile file)
        {
            ...
            // Simulate OCR processing (replace with real OCR logic later)
            // For now, just return a mock result
            var mockResult = new OcrResultDto
            {
                RawText = "Mock OCR result: Example item 1 $10.00, Example item 2 $5.00, Tax $1.50, Tip $2.00"
            };
