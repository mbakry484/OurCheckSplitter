...
namespace OurCheckSplitter.Api.Controllers
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        [SwaggerOperation(
            ...
            Description = "Retrieves a list of all receipts with their associated friends and items",
        ...
        [SwaggerOperation(
            ...
            Description = "Creates a new receipt with the provided details",
        ...
        [SwaggerOperation(
            ...
            Description = "Deletes a receipt and its associated friends and items",
        ...
        [SwaggerOperation(
            Summary = "Assign friends to receipt",
            Description = "Assigns friends to a receipt",
            OperationId = "AssignFriendsToReceipt",
            Tags = new[] { "Receipts" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Assign items to receipt",
            Description = "Assigns items to a receipt",
            OperationId = "AssignItemsToReceipt",
            Tags = new[] { "Receipts" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Assign friends to items",
            Description = "Assigns friends to items in a receipt",
            OperationId = "AssignFriendsToItems",
            Tags = new[] { "Receipts" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Assign friends to whole item",
            Description = "Assigns friends to a whole item in a receipt",
            OperationId = "AssignFriendsToWholeItem",
            Tags = new[] { "Receipts" }
        )]
        ...
        [SwaggerOperation(
            Summary = "Get friend amounts",
            Description = "Retrieves the amounts each friend owes for a receipt",
            OperationId = "GetFriendAmounts",
            Tags = new[] { "Receipts" }
        )]
