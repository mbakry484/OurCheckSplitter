    ...
    public class FriendsController : ControllerBase
    {
            ...
            [FromQuery] string? searchTerm = null)
        {
            ...
            var query = _context.Friends
                ...
                .Include(f => f.FriendReceipts)
                    .ThenInclude(fr => fr.Receipt)
                .AsQueryable();
            ...
            if (!string.IsNullOrWhiteSpace(searchTerm))
            {
                ...
                query = query
                    .Where(f => 
                        ...
                        // Search by receipt names that friend is part of
                        f.FriendReceipts.Any(fr => 
                            fr.Receipt.Name != null && 
                            fr.Receipt.Name.ToLower().Contains(searchTermLower)
                        )
                    );
            }
