...
namespace OurCheckSplitter.Api.Controllers
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        {
            Console.WriteLine("=== REGULAR CREATE RECEIPT ENDPOINT CALLED ===");
            ...
            try
            {
                ...
                Console.WriteLine($"Returning DTO: TaxType={receiptDto.TaxType}, TipsIncludedInTotal={receiptDto.TipsIncludedInTotal}");
                return Ok(receiptDto);
            }
            catch (Exception ex)
            {
