...
namespace OurCheckSplitter.Api.Controllers
{
    ...
    public class FinalAmountController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetFriendAmounts(int receiptId)
        {
            ...
            // When tipsIncludedInTotal is false, the receipt total should match the calculated total
            // When tipsIncludedInTotal is true, the receipt total includes tips
            var expectedTotal = tipsIncluded ? receiptTotal : receiptTotal;
