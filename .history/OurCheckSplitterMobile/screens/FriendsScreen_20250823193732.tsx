...
const FriendsScreen = ({ navigation, route }: FriendsScreenProps) => {
  ...
  const handleFriendPress = (friend: Friend) => {
    // Use mock data for detailed receipts immediately
    const mockFriend = getMockFriends().find(f => f.id === friend.id);
    if (mockFriend && mockFriend.detailedReceipts) {
      setSelectedFriend({
        ...friend,
        detailedReceipts: mockFriend.detailedReceipts
      });
    } else {
