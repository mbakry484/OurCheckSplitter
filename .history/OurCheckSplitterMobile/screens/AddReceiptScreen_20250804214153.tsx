  ...
  const renderItem = (item: ReceiptItem, index: number) => {
    ...
    return (
      <View key={item.id} style={styles.itemContainer}>
        ...
        {/* Show only selected friends from top section */}
        {selectedFriends.length > 0 && (
          <View style={styles.friendSelectionContainer}>
            <View style={styles.friendSelectionHeader}>
              ...
              <View style={styles.friendSelectionButtons}>
                <TouchableOpacity
                  style={styles.friendSelectionButton}
                  onPress={() => selectAllFriendsForItem(item.id)}
                >
                  <Text style={styles.friendSelectionButtonText}>Select All</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.friendSelectionButton}
                  onPress={() => deselectAllFriendsForItem(item.id)}
                >
                  <Text style={styles.friendSelectionButtonText}>Deselect All</Text>
                </TouchableOpacity>
              </View>
            </View>
