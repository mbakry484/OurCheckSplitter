...
const HomeScreen = ({ navigation }: HomeScreenProps) => {
  ...
  const averagePerReceipt = recentReceipts.length > 0 ? totalYouPaid / recentReceipts.length : 0;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topSummaryCards}>
          ...
          <View style={styles.summaryCard}>
            <Ionicons name="calculator-outline" size={20} color="#FF6B6B" />
            <Text style={styles.summaryNumber}>${averagePerReceipt.toFixed(0)}</Text>
            <Text style={styles.summaryLabel}>Avg per Receipt</Text>
          </View>
        </View>
