  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const receiptDto = {
        ...
        TaxType: taxType === '-' ? null : (taxType === '%' ? 'percentage' : 'amount'),
      ...
      // Create receipt via API (using debug endpoint)
      const response = await receiptApi.debugCreateReceipt(receiptDto);
