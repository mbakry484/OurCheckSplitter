    ...
    <SafeAreaView style={styles.container}>
      ...
      <View ref={receiptRef} style={styles.receiptContainer} collapsable={false}>
        <View style={styles.placeholderContainer}>
          <Text style={styles.placeholderTitle}>New Receipt Layout</Text>
          <Text style={styles.placeholderText}>We removed the previous breakdown. Let's build the new digital receipt here.</Text>
          {!isSharing && (
            <TouchableOpacity 
