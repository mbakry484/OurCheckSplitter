        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.sectionContent}>
              <Text>Has basicData: {basicData ? 'Yes' : 'No'}</Text>
              <Text>Receipt Title: {receiptTitle || 'Empty'}</Text>
              <Text>Expected Total: {expectedTotal}</Text>
              <Text>onEditBasicData: {onEditBasicData ? 'Yes' : 'No'}</Text>
            </View>
          </View>
