...
const getApiBaseUrl = () => {
  ...
  // Development URLs - trying host machine IP instead of 10.0.2.2
  // Using your actual IP address from ipconfig
  return 'http://192.168.1.14:5276/api';  // Your host machine IP
...
export const receiptApi = {
  ...
  // Get receipt by ID
  getReceiptById: async (id: number) => {so you are 
